...
const translations = {
  pl: {
    ...
    hero_title_small_mobile: 'Chrześcijańska Wspólnota',
    hero_title_main_mobile: 'Zielonoświątkowa',
    hero_title_sub_mobile: 'Zbór w Legnicy',
  ...
  ru: {
    ...
    hero_title_small_mobile: 'Христианская община',
    hero_title_main_mobile: 'Пятидесятников',
    hero_title_sub_mobile: 'Церковь в Легнице',
  ...
  en: {
    ...
    hero_title_small_mobile: 'Christian Community',
    hero_title_main_mobile: 'Of Pentecostals',
    hero_title_sub_mobile: 'Church in Legnica',
